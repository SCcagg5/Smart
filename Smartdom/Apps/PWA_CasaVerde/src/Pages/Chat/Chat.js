    ...
    render() {
        ...
        return (
            <div>
                                                                            ...
                                                                            >
                                                                                <div style={{
                                                                                    ...
                                                                                    <div style={{marginTop: 10}}>
                                                                                        <div align="right">
                                                                                            <span
                                                                                                style={{fontWeight: "bold"}}>Total: <span> €</span></span>
                                                                                        </div>
                                                                                        <div align="center"
                                                                                             style={{marginTop: 15}}>
                                                                                            <button
                                                                            ...
                                                                            msg.type === "audio" ?
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <h6 style={{
                                                                                        ...
                                                                                        fontSize: "0.6rem",
                                                                                        marginLeft: 25
                                                                                    }}>{main_functions.toMMSS(msg.duration.toString())}</h6>
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <div style={{
                                                                                        ...
                                                                                        <div style={{marginTop: 10}}>
                                                                                            <div align="right">
                                                                                                <span
                                                                                                    style={{fontWeight: "bold"}}>Total: <span>1200
                                                                                                    €</span></span>
                                                                                            </div>
                                                                                            <div align="center"
                                                                                                 style={{marginTop: 15}}>
                                                                                            ...
                                                                                            (msg.responses || []).map((resp, key) => (
                                                                                                <div
                                                                                                    ...
                                                                                                    <AtlButton
                                                                                                            ...
                                                                                                            if (resp.id === "download" || resp.id === "share") {
                                                                                                                ...
                                                                                                                if (test === false) {
                                                                                                                    ...
                                                                                                                    setTimeout(() => {
                                                                                                                        ...
                                                                                                                        this.setState({
                                                                                                                            messages: msgs,
                                                                                                                            procuration_responseType: "client",
                                                                                                                            waitResponseToBot: true
                                                                                                                        })
                                                                                                                        setTimeout(() => {
                                                                                                                            this.scrollToBottom();
                                                                                                                        }, 250)
                                                                                                        ...
                                                                                                        iconAfter={resp.selected && resp.selected === true ?
                                                                                                            <CheckIcon
                                                                                                                fontSize="small"
                ...
                <Drawer anchor="bottom" open={this.state.openBottomPayModal}
                        onClose={() => this.setState({openBottomPayModal: false})}
                        style={{borderRadius: 20}}
                >
                    <div style={{padding: 15}}>
                        ...
                        <div style={{marginTop: 20, marginBottom: 20}}>
                            ...
                            <div style={{display: "flex", cursor: "pointer", marginBottom: 10}}>
                                <img alt="" style={{width: 30, height: 30, objectFit: "contain"}}
                                     src={creditcard_logo}/>
                ...
                >
                    <div style={{padding: 15, height: 600, width: 300, paddingBottom: 50}}>
                        ...
                        <h6 style={{color: "darkblue"}}>Glisser des fichiers de votre drive directement dans la
                            discussion</h6>
