        ...
        return (
            ...
            <ScrollView style={styles.scroll}>
                <View style={styles.userRow}>
                    <View style={styles.userImage}>
                        <Avatar
                            rounded
                            size="large"
                            source={this.state.user.photoURL ? {uri: this.state.user.photoURL} : defaultAvatar}
                        />
                    </View>
                    <View>
                        <Text style={{fontSize: 16}}>{this.state.user.displayName || this.state.user.fullname} </Text>
                        <Text
                            style={{
                                color: 'gray',
                                fontSize: 16,
                ...
                <View>
                    ...
                    <ListItem
                        title="Adresse"
                        rightTitle={this.state.user.adress}
