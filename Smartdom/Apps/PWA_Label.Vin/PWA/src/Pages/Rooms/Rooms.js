                ...
                <div style={{marginTop: 90, padding: 20, minHeight: "100vh"}}>
...

                    {
                        this.state.rooms.length === 0 ?
                            <div>
                                <h6 style={{color:"red",textAlign:"center",marginTop:"40%"}}>Aucun room encore ajouté !</h6>
                            </div>  :
                            ...
                            <div className="row mt-3 ml-1 mr-1" style={{maxWidth: 1000}}>
                                {
                                    (this.state.rooms || []).map((room, key) => (
                                        <div className="col-lg-3 mb-2">
                                            <div className="card-container" style={{backgroundColor: room.color}}
                                                 onClick={() => {
                                                ...
                                                <div style={{marginTop: 60, marginLeft: 10}}>
                                                    <div style={{display: "flex"}}>
                                                        <i className="fa fa-users"
                                                           style={{color: "#fff", fontSize: 14}}>&nbsp;{room.members.length}</i>
                                                        <i className="fa fa-tasks" style={{
                                                            color: "#fff",
                                                            fontSize: 14,
                                                            marginLeft: 10
                                                        }}>&nbsp;{(room.tasks || []).length}</i>
