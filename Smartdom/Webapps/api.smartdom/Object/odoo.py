...
class odoo:
    ...
    def list_index(self, name, offset = 0, limit = 10, id = 0, arg = None):
            data = {
                    ...
                    "city_zip": { "index": "res.city", "arg": [], "opt": {"name": str(arg), "args": [], "operator": "ilike", 'limit': int(limit)}, "model": "name_search"},
                    ...
                    "country_state": { "index": "res.country.state", "arg": [], "opt": {"name": str(arg), "args": [], "operator": "ilike", 'limit': int(limit)}, "model": "name_search"},
