...
let entrepriseSARLService = {
    ...
    GenerateActeConstitutif(uid,pays){
        ...
        return fetch("http://149.202.172.15:3001/api"+'/GenerateActeConstitutif/'+uid+'/'+pays, {
            method: 'GET',
        }).then(response => response.blob()
        ).catch(error => {
            console.log(error);
    ...
    GenerateProcuration(uid,pays){
        ...
        return fetch("http://149.202.172.15:3001/api"+'/GenerateProcuration/'+uid+'/'+pays, {
            method: 'GET',
        }).then(response => response.blob()
        ).catch(error => {
            console.log(error);
    ...
    GenerateDeclaration(uid,pays){
        ...
        return fetch("http://149.202.172.15:3001/api"+'/GenerateDeclaration/'+uid+'/'+pays, {
            method: 'GET',
        }).then(response => response.blob()
        ).catch(error => {
            console.log(error);
    ...
    GenerateOptingOutGerant(uid,pays){
        ...
        return fetch("http://149.202.172.15:3001/api"+'/GenerateOptingOutGerant/'+uid+'/'+pays, {
            method: 'GET',
        }).then(response => response.blob()
        ).catch(error => {
            console.log(error);
    ...
    GenerateRequisition(uid,pays){
        ...
        return fetch("http://149.202.172.15:3001/api"+'/GenerateRequisition/'+uid+'/'+pays, {
            method: 'GET',
        }).then(response => response.blob()
        ).catch(error => {
            console.log(error);
