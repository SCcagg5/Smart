...
class signSARLDocDec extends Component {
    ...
    componentDidMount() {
        ...
        entrepriseSARLService.GenerateDeclaration(SocietyUID, pays).then(res => {
            this.setState({
                pdfFile: res,
                uid: SocietyUID,
                pays: pays,
    ...
    handlePDFChange = (name, eseName, url) => {
        ...
        if(associate !== undefined) {
            ...
            firebase.database().ref('/society/' + this.props.match.params.SocietyUID).child('sAssociate').child(indexAsso).update({
                'signatureDeclaration': url
            }).then(res => {
                console.log("ok");
                entrepriseSARLService.GenerateDeclaration(this.state.uid, this.state.pays).then(res => {
                    this.setState({
                        pdfFile: res
                    });
                }).then(res => {
                                        ...
                                        <div className="card-body" style={{padding: '0.9rem'}}>
                                            <div className="float-right">
                                                <button type="button"
                                                    ...
                                                    {
                                                        this.state.actionnaire.signatureDeclaration === "" ? "Signer le document" : "Vous avez signé le document"
                                                    }
                                    ...
                                    (this.state.associates || []).map((item, key) => (
                                        ...
                                        item.fullname= item.firstname + " " + item.lastname,
                                            item.signatureDeclaration !== "" ?
                                                ...
                                                <div className="col-md-4">
                                                    ...
                                                    <div className="card-box ribbon-box">
                                                        ...
                                                        <div className="text-center">
                                                            <img src={item.signatureDeclaration} alt="" height="65" width="200"
                                                                 style={{
                                                                     objectFit: "none",
                                                                     marginTop: 5,
                                                ...
                                                item.signatureDeclaration === "" && item.id !== this.props.match.params.actID ?
