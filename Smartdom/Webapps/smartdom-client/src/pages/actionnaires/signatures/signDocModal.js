                                ...
                                <Button variant="contained" color="secondary" style={{fontSize: 14}}
                                        ...
                                        onClick={() => {
                                            ...
                                            if(this.state.signatureChoise === 'Dessiner'){
                                                handlePDFChange(this.state.name, this.state.eseName, this.sigCanvas.getTrimmedCanvas().toDataURL('image/png'));
                                                closeModal();
                                            }

                                            if(this.state.signatureChoise === 'Importer'){

                                                handlePDFChange(this.state.name, this.state.eseName, this.state.signfile);
                                                closeModal();
                                            }
