                        ...
                        <Suspense fallback={loading()}>
                            ...
                            <div className="row w-100 align-self-start " >
                                <div className="row">
                                    <div className="col-md-2 ">
                                       ...
                                       <small> Service salle de réunions</small>
                                    </div>
                            ...
                            <div className="row w-100   mt-3">
                                <div className="col-md-4 ">
                                    ...
                                    <div>
                                        <h5 style={ {fontWeight:"bold"}}>MES SERVICES SALLES DE RÉUNIONS </h5>
                                    </div>

                                    <div>
                                        <a href="/salles/abonnement"><Button  className="bg-danger" >Accès mon abonnement audio visio  </Button></a>
                                    </div>
                                ...
                                <div className="col-md-8 ">
                                    ...
                                    <div>
                                        <h5 style={{fontWeight:"bold"}}>MES RÉUNIONS PASSÉES </h5>
                                    </div>
                                    <div className="row justify-content-end">
                                        <button className="btn btn-primary  ">Autre réunions passées</button>

                                    </div>
                                    <div>
                                        <h6 style={{color:"#a6a6a6"}}>Ma dernière réunion</h6>
                                    </div>
                                    <div>
                                        <div className="row align-items-center mt-3" style={{borderBottomWidth:"0.5px", borderBottomStyle:"solid"}}>
                                            <div className="col-md-2">
                                                <h6 className="font-weight-bold">5200</h6>

                                            </div>
                                            <div className="col-md-3 ">
                                                <small>Réception le 24 juil 2019</small>
                                            </div>
                                    ...
                                    <div>
                                        <h5 style={{fontWeight:"bold"}}>MES PROCHAINES RÉUNIONS  </h5>
                                    </div>
                                    <div className="container " style={{maxheight:"20%",height:"20%" ,overflow:"auto"}}>
                                        {rProchaine.map((item)=>(
                                                ...
                                                <div className="row align-items-center mt-3" style={{borderBottomWidth:"0.5px", borderBottomStyle:"solid"}}>
                                                    ...
                                                    <div className="col-md-3 ">
                                                        <small>Réception le {item.date}</small>
                                                    </div>
                                                    <div className="col-md-2 text-right">
