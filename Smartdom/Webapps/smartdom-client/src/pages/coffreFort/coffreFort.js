...
class coffreFort extends Component {
    ...
    showStockoptionDocument = (actiokey, titreKey, opKey, type) => event => {
        this.setState({loading: true});
        let uid = this.state.selectedEntreprise.uniqueId;
        let typeActio = "";
        if (type === "associate") {
        ...
        augmCapitalService.getBSASuisseDoc(uid, actiokey, typeActio, titreKey, opKey).then(res => {
                                                                ...
                                                                <div>
                                                                    <div className="row">
                                                                        <div className="col-md-12">
                                                                            <h5>Augmentation de capital
                                                                                du {moment(item.dateCreation).format("DD MMMM YYYY")}</h5>
                                                ...
                                                <div className={"tab-pane fade"}
                                                    ...
                                                    </h6>
                                                    {
                                                        this.state.selectedEntreprise.paysOrigine === "Suisse" ?
                                                            <div className="row">
                                                                {
                                                                    (this.state.selectedEntreprise.sAssociate || []).map((item, actiokey) => (
                                                                                ...
                                                                                <div className="col-sm-2">
                                                                                    <a style={{cursor: 'pointer'}}>
                                                                                        <img src={pdfImage}
                                                                                             style={{maxHeight: 60}}
                                                                                             alt="attachment"
                                                                                             onClick={this.showStockoptionDocument(actiokey, titreKey, opKey, "associate")}
                                                                                             className="img-thumbnail img-responsive"/>
                                                                                    </a>
                                                                                    {
                                                                                        this.state.selectedEntreprise.paysOrigine === "Suisse" ?
