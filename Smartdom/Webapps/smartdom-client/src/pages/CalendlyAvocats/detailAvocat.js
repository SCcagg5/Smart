...
class detailAvocat extends Component {
    ...
    componentDidMount() {
       ...
       // this.setState({beneficaire:localStorage.getItem('beneficaire')})
    ...
    componentWillMount() {
        console.log(localStorage.getItem('FNbeneficaire'))
        ...
        console.log( localStorage.getItem('username') +"  test "+ localStorage.getItem('email'))
    }

    render() {
        let data="https://calendly.com/jawher-zairi?name="+localStorage.getItem('username')+"&email="+localStorage.getItem('email')+"&a1=RDV téléphonique pour la finalisation d’un plan de stock option pour Monsieur "+localStorage.getItem('FNbeneficaire')+" "+localStorage.getItem('LNbeneficaire')+". Ci-dessous le lien du document à discuter"
