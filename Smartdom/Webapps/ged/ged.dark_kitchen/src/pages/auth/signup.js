                                    ...
                                    <CardBody className="p-4 position-relative">
                                        ...
                                        <AvForm onValidSubmit={this.signup}>
                                            ...
                                            {/*<AvGroup className="mb-3">
                                                ...
                                                <AvInput type="text" name="fname" id="fname"
                                            ...
                                            <AvGroup className="mb-3">
                                                ...
                                                <AvInput type="text" name="lname" id="lname"
                                            ...
                                            <FormGroup>
                                                <button className="btn-block btn" style={{backgroundColor:login_btn_color,marginTop:65}}>S'inscrire</button>
                                            </FormGroup>
                                            <div align="center">
