...
export default function TableClientNL(props) {
                            ...
                            <div className="page-title-box">
                                <div className="row ">
                                    <div
                                        ...
                                        style={{width: "10%"}}>
                                        <h4 style={{color: "white",marginTop:5}}>Nl beautySane</h4>
                                    </div>
                                    <hr style={{
                        ...
                        <div className="card-body">
                            <table className="table table-bordered">
                                ...
                                <tr style={{padding:10}}>
                                    ...
                                    <TableCell  style={{width:"5%",fontWeight:600}}>Diago Check</TableCell>
                                ...
                                <tbody>
                                {clients!=undefined&&clients.map((item,key)=>(
