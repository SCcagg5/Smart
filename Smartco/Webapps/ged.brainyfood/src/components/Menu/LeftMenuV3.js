                        ...
                        <div>
                            ...
                            >
                                ...
                                <div style={{display: "flex"}}>
                                    ...
                                    <Typography variant="inherit" style={{color: "#000", marginTop: 3}}>Annuaire</Typography>
                                </div>
                                <div style={{height: 1, backgroundColor: "#f0f0f0", marginTop: 10, marginBottom: 10}}/>
                            </div>
                            {
                            ...
                            </div>
                            {
                                props.showMarketplaceMenuItems === true &&
                                <div>
                                    <MarketplaceMenuItems items={data.marketplaceMenuItem} selectedMarketplaceItem={props.selectedMarketplaceItem}
                                                   onClick={(nodeId) => {
