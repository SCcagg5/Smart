...
const getLabel = ({option}) => {
    return (
        <React.Fragment> <img src={option.image} alt="" style={{width: 30, height: 30}}/>&nbsp;&nbsp;{option.id}
        </React.Fragment>
    );
}
const getOAContactLabel = ({option}) => {
    return (
        <React.Fragment> <img src={option.imageUrl || userAvatar} alt=""
                              style={{width: 30, height: 30}}/>&nbsp;&nbsp;{option.nom + " " + option.prenom}
        </React.Fragment>
    );
}
let expanded = [];
            ...
            contactSelectOptions.push({
                ...
                label: <div>
                    <img alt="" src={contact.imageUrl || null}
                         style={{width: 30, height: 30, objectFit: "cover"}}/> {" "}{contact.nom + " " + contact.prenom}
                </div>
            })
        })
        return (
            <div>
                ...
                <MuiBackdrop open={this.state.firstLoading}/> <MuiBackdrop open={this.state.loading}/>
                <div style={{marginRight: 50, marginTop: 75, marginLeft: 5}}>
                                                        ...
                                                        <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div align="center" className="mt-5">
                                                                        ...
                                                                        <p style={{fontSize: "1rem"}} className="mt-2">
                                                                            Faites glisser et déposez un documents PDF sur le terrain ou sélectionnez un fichier depuis votre ordinateur.</p>
                                                            ...
                                                            <div align="center">
                                                                <div className="ml-2 mt-2">
                                                                    ...
                                                                    <p style={{fontSize: "1.0rem"}}
                                                                       className="mt-2">
                                                                        Saisissez l'adresse e-mail des personnes qui doivent signer ce document.
                                                                    </p>
                                                                    <div className="mt-4">
                                                                        <strong style={{
                                                                            color: "#293d66",
                                                                            fontSize: "1.1rem"
                                                                        }}>Vous vous signez ?</strong>
                                                                        <div
                                                                        ...
                                                                        <div className="mt-3">
                                                                            <strong
                                                                                style={{
                                                                                    color: "#293d66",
                                                                                    fontSize: "1.1rem"
                                                                                }}>Ajouter d'autres signataires</strong>
                                                                            <ReactMultiEmail
                                                                    ...
                                                                    <div className="sk_viewr">
                                                                        <div className="sk_pdfviewr">
                                                                            <PDFViewer
                                                                                ...
                                                                                alert={
                                                                                    <h5 style={{color: "red"}}>Une erreur s'est produite lors de chargement du doument !</h5>
                                                                                }
                                                                            />
                                                                        </div>
                                                                        <div className="sk_signatures_viewr">
                                                                            <div
                                                                                ...
                                                                                <h1 className="skh1">Positionnez les champs de signature</h1>
                                                                                <p style={{fontSize: "1.1rem"}}>
                                                                                    Faites glisser et déposez les champs de signature à l'endroit où les gens doivent signer.</p>
                                                                                <div style={{marginTop: "2.8rem"}}>
                                                                                    ...
                                                                                    <p style={{
                                                                                        ...
                                                                                        Une invitation sera envoyé au signataires dés que vous validez votre signature.
                                                                                    </p>
                                                                                }
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div>
                                                                <div className="sk_detail_container">
                                                                    ...
                                                                    <div className="mt-4">
                                                                        <h1 className="skh1"
                                                                            style={{fontSize: "2.0rem"}}>Les invitations à signer sont envoyée avec succès</h1>
                                                                        ...
                                                                        <div className="sk_detail_upload">
                                                                            ...
                                                                            <div className="sk_detail_upload_text">
                                                                                <div
                                                                                    ...
                                                                                    <strong
                                                                                        style={{color: "#293d66"}}>Document</strong><br/> {this.state.uploadedName}
                                                                                </div>
                                                                                {
                                                                                    this.state.signMySelf === true &&
                                                                                    <div
                                                                                        className="sk_detail_upload_text_row">
                                                                                        <strong
                                                                                            style={{color: "#293d66"}}>Signataire 1</strong><br/> {localStorage.getItem("email")}
                                                                                    </div>
                                                                                } {
                                                                                this.state.signatiaresEmails.map((item, key) =>
                                                                                    <div key={key}
                                                                                         className="sk_detail_upload_text_row">
                                                                                        <strong
                                                                                            style={{color: "#293d66"}}>Signataire {this.state.signMySelf === true ? key + 2 : key + 1}</strong><br/> {localStorage.getItem("email")}
                                                                                    </div>
                                                                                )
                                                                            }
                                                                            </div>
                                                        ...
                                                        <div className="col-lg-12">
                                                            ...
                                                            />
                                                                ...
                                                                <div style={{marginTop: 30}} className="text-left">
                                                                    <Tabs> <TabList> <Tab>Informations générales</Tab>
                                                                        <Tab>Famille & Vie privée</Tab>
                                                                        <Tab>Parcours professionnel</Tab>
                                                                        <Tab>Formations</Tab> <Tab>Affiliations</Tab>
                                                            ...
                                                            />
                                                                ...
                                                                <div style={{marginTop: 30}} className="text-left">
                                                                    <Tabs> <TabList> <Tab>Informations générales</Tab>
                                                                        ...
                                                                        <Tab>Ouverture mandat </Tab> </TabList>
                                                                        <TabPanel>
                                                                            <h5 style={{marginTop: 20}}>Informations générales</h5>
                                                                            <div className="row"
                                                                                 style={{marginTop: 35}}>
                                                                            ...
                                                                            <div className="row"
                                                                                ...
                                                                                <div className="col-sm-6">
                                                                                    ...
                                                                                    <Input
                                                                                        ...
                                                                                        onChange={this.handleChange('selectedSociete', 'capitaux_levés')}> </Input>
                                                                                </div>
                                                                            </div>
                                                                        </TabPanel> <TabPanel>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div className="col-md-3">
                                                                                        <div>Taux Horaire collaborateur -B
                                                                                        </div>
                                                                                        <input
                                                                                            className="form-control"
                                                                                            type="text"
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-12">
                                                            ...
                                                            <div className="card-box text-center"
                                                                 style={{marginTop: 1}}>
                                                                <div style={{marginTop: 30}} className="text-left">
                                                                    <Tabs> <TabList> <Tab>New time Entree </Tab>
                                                                        <Tab>List imputation </Tab> {
                                                                            localStorage.getItem("role") === "admin" &&
                                                                            [
                                                                                <Tab key={0}>Imputation client </Tab>,
                                                                                <Tab
                                                                                    key={1}>Imputation team & scheduled time </Tab>,
                                                    ...
                                                    <div className="col-lg-12">
                                                        ...
                                                        <div className="card-box text-center"
                                                            ...
                                                            <div style={{marginTop: 10}} className="text-left">
                                                                <Tabs> <TabList> <Tab>This Week</Tab>
                                                                    <Tab>Scheduled Next Week </Tab> </TabList>
                                                                    <TabPanel>
                                                                        <div
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-12">
                                                        ...
                                                        <div className="card-box text-center"
                                                             style={{marginTop: 1}}>
                                                            <div style={{marginTop: 10}} className="text-left">
                                                                <Tabs> <TabList> <Tab>All projects</Tab>
                                                                    <Tab>This Week</Tab> <Tab>Scheduled Next Week </Tab>
                                                                </TabList> <TabPanel>
                                                                    <div
                                                                        className="row justify-content-start align-items-center mt-3">
                                                                        <div>
                                                                ...
                                                                </TabPanel> <TabPanel> </TabPanel> </Tabs>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div style={{padding: "1.6rem 2rem"}}>
                                ...
                                <div className="rs_doc_actions">
                                    <IconButton aria-label="Visualiser" title="Visualiser" color="primary"
                                                ...
                                                }}> <FindInPageOutlinedIcon/> </IconButton> <IconButton
                                    aria-label="Télécharger" title="Télécharger" color="default"
                                    download={true} target="_blank"> <CloudDownloadOutlinedIcon/> </IconButton>
                                    <IconButton aria-label="Inviter" title="Inviter" color="primary">
                                        <PersonAddOutlinedIcon/> </IconButton> <IconButton aria-label="Supprimer"
                                                                                           title="Supprimer"
                                                                                           color="secondary">
                                ...
                                (this.state.selectedDoc.signers || []).map((signer, key) =>
                                    <div key={key} className="rs_row">
                                        ...
                                        <div className="rs_row_span rs_row_span">
                                            <div className="badge bg-soft-warning text-warning p-1 ">En attente
                                            </div>
                                        </div>
                                    </div>
                                )
                    ...
                    </Drawer> <Drawer anchor="right" open={this.state.openRightContactModalDetail} onClose={() => {
                ...
                </Drawer> <Drawer anchor="right" open={this.state.openRightSocieteModalDetail} onClose={() => {
                ...
                </Drawer> <Modal isOpen={this.state.showPDFModal} size="lg" zIndex={1500}
                                 toggle={() => this.setState({showPDFModal: !this.state.showPDFModal})}> <ModalHeader
                    toggle={() => this.setState({showPDFModal: !this.state.showPDFModal})}> Document </ModalHeader>
                    <ModalBody> <PDFViewer
                        document={{
                    ...
                    /> </ModalBody> </Modal> <Modal isOpen={this.state.showPdfPreviewModal} size="lg" zIndex={1500}
                    ...
                    showPdfPreviewModal: !this.state.showPdfPreviewModal,
                    isDocPreviewReady: false
                })}> Document </ModalHeader> <ModalBody>
                    {
                        this.state.isDocPreviewReady === true && (
                            <PdfView width={"100%"} height={800}> <Resume
                ...
                </ModalBody> </Modal> <Modal isOpen={this.state.showPdfFlipModal} size="lg" zIndex={1500}
                                             toggle={() => this.setState({showPdfFlipModal: !this.state.showPdfFlipModal})}>
                    <ModalHeader
                        toggle={() => this.setState({showPdfFlipModal: !this.state.showPdfFlipModal})}> Document </ModalHeader>
                    <ModalBody> <FlipPage orientation="horizontal" uncutPages={true} width={"100%"} height={800}
                    ...
                    </FlipPage> </ModalBody> </Modal> <Modal isOpen={this.state.newFolderModal} size="md"
                                                             centered={true} zIndex={1500}
                                                             toggle={() => this.setState({
                ...
                > <ModalHeader toggle={() => this.setState({
                    newFolderModal: !this.state.newFolderModal,
                    newFolderFromRacine: false
                })}> Nouveau doossier </ModalHeader> <ModalBody>
                ...
                </ModalBody> </Modal> <Modal isOpen={this.state.showInviteModal} size="md" centered={true} zIndex={1500}
                                             toggle={() => this.setState({showInviteModal: !this.state.showInviteModal})}>
                    <ModalHeader
                        toggle={() => this.setState({showInviteModal: !this.state.showInviteModal})}> Ajouter des participants </ModalHeader>
                    <ModalBody>
                        <p style={{
                            fontFamily: "sans-serif",
                            marginTop: 25
                        }}>Partagez ces informations avec les personnes que vous souhaitez inviter à la réunion.</p>
                    ...
                    </ModalBody> </Modal> <Modal isOpen={this.state.showModalAdd} size="md" centered={true}
                                                 zIndex={1500}
                    ...
                    <div style={{width: 400}}>
                        <FormControl style={{width: "80%"}}> <InputLabel shrink
                                                                         id="demo-simple-select-placeholder-label-label"> Domaine n°1 </InputLabel>
                            <MuiSelect
                                style={{width: "100%"}}
                            ...
                            > <MenuItem value={"COMPTABILITE"}>COMPTABILITÉ</MenuItem> <MenuItem
                                value={"SALAIRES"}>SALAIRES</MenuItem> <MenuItem value={"TVA"}>TVA</MenuItem> <MenuItem
                                value={"IMPOTS"}>IMPOTS</MenuItem> </MuiSelect> </FormControl> <FormControl
                        style={{width: "80%"}}> <InputLabel style={{fontSize: "100%"}}
                                                            id="demo-mutiple-chip-label">Les spécialités recherchées </InputLabel>
                        <MuiSelect
                ...
                </ModalBody> </Modal> {/*Share folder Modal*/} <Dialog open={this.state.openShareDocModal}
                                                                       onClose={() => {
                                                                           this.setState({openShareDocModal: !this.state.openShareDocModal})
                                                                       }} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title" style={{marginLeft: -22, marginBottom: -10}}> <IconButton
                        aria-label="Partager" color="primary"> <PersonAddIcon/>
                    </IconButton> Partager avec des personnes et des groupes </DialogTitle> <DialogContent>
                    <div className="row">
                        <div className="col-md-12">
                ...
                </DialogContent> <DialogActions style={{padding: 20}}> <MuiButton onClick={() => {
                    this.setState({openShareDocModal: false})
                }} color="primary" style={{textTransform: "capitalize"}}> Annuler </MuiButton> <MuiButton
                    ...
                    color="primary" variant="contained" style={{textTransform: "capitalize"}}> Envoyer </MuiButton>
                </DialogActions> </Dialog> <Dialog open={this.state.openNewRoomModal} onClose={() => {
                    this.setState({openNewRoomModal: !this.state.openNewRoomModal})
                }}
                                                   aria-labelledby="form-dialog-title"> <DialogTitle disableTypography
                                                                                                     id="form-dialog-title">
                    <Typography variant="h6">Créer Room</Typography> <IconButton aria-label="close"
                                                                                 style={{
                                                                                     position: 'absolute',
                                                                                     right: 5,
                                                                                     top: 5,
                            ...
                            >
                                {
                                    this.state.contacts.filter(x => x.role === "avocat").map((contact, key) =>
                                        ...
                                        }}> <ListItemIcon> <Avatar src={contact.imageUrl}/> </ListItemIcon> <Typography
                    ...
                    color="primary" variant="contained" style={{textTransform: "capitalize"}}> Créer </MuiButton>
                </DialogActions> </Dialog> <Dialog open={this.state.openAdvancedSearchModal} maxWidth="xl"
                                                   onClose={() => {
                                                       this.setState({openAdvancedSearchModal: !this.state.openAdvancedSearchModal})
                                                   }}
                                                   aria-labelledby="form-dialog-title"> <DialogTitle disableTypography
                                                                                                     id="form-dialog-title">
                    <Typography variant="h6">Recherche avancée</Typography> <IconButton aria-label="close"
                                                                                        style={{
                                                                                            position: 'absolute',
                                                                                            right: 5,
                                                                                            top: 5,
                ...
                </DialogTitle> <DialogContent> <SearchClientsContainer societes={this.state.annuaire_clients_mondat}
                                                                       contacts={this.state.contacts}
