...
import bodycheckservice from "../../provider/bodycheckservice"
...
export default class Main extends React.Component {
        ...
        SmartService.getGed(
          ...
          .then((gedRes) => {
            if (gedRes.succes === true && gedRes.status === 200) {
              ...
              let meeturl = 'https://meet.smartdom.ch/brainyfood_' + moment().format('DDMMYYYYHHmmss');
    ...
    SmartService.addFolder({
      ...
      if (addFolderRes.succes === true && addFolderRes.status === 200) {
        ...
        for (let i = 0; i < files.length; i++) {
          ...
          calls.push(
              axios.request({
              method: 'POST', url: data.endpoint + '/ged/894ca0ed-8b4a-41fd-aeff-8de26ee1bcf9/doc/addfile',
              data: formData,
              headers: {
  ...
  getbodycheck(uid){
    ...
    bodycheckservice.getdata(uid).then(r =>{
      if (r.data!=""){
        this.state.selectedContact.bodycheck=r.data
                                          ...
                                          <FileUploader
                                            ...
                                            onDrop={(acceptedFiles, rejectedFiles) => {
                                              ...
                                              axios.request({
                                                ...
                                                url:
                                                  data.endpoint +
                                                  '/ged/894ca0ed-8b4a-41fd-aeff-8de26ee1bcf9/doc/addfile',
                                                data: formData,
                                                headers: {
                                                  'Content-Type':
                                                    'multipart/form-data',
                          ...
                          <div align="center" style={{ marginTop: 200 }}>
                            ...
                            <div style={{ display: 'inline-flex' }}>
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  let meeturl =
                                    'https://meet.smartdom.ch/brainyfood_' +
                  ...
                  <div className="sk_elupload_drag">
                    <FileUploader
                      ...
                      onDrop={(acceptedFiles, rejectedFiles) => {
                        ...
                        axios.request({
                          method: 'POST',
                          url: data.endpoint + '/ged/894ca0ed-8b4a-41fd-aeff-8de26ee1bcf9/doc/addfile',
                          data: formData,
                          headers: {
                            'Content-Type':
                              'multipart/form-data',
