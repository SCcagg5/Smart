                        ...
                        <Table aria-label="collapsible table" style={{marginTop: 20}} size="small">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="center" style={{fontWeight: "bold"}}>Montant HT</TableCell>
                            ...
                            <TableBody>
                                {
                                    searchFilter.map((row, key) => (
                                        <Row key={key} row={row} index={key}
                                             ...
                                             openFactureFolder={props.openFactureFolder}
    ...
    return (
        <React.Fragment>
            <TableRow style={{borderBottom: row.type ? "1px solid rgba(224, 224, 224, 1)" : "none"}}
                ...
                {/*<TableCell align="center">
                    {row.type && (row.type === "provision" || row.type === "avance_frais") ? "" : utilFunctions.formatDuration(nb_heures.toString())}
                </TableCell>*/}
                ...
                <TableCell align="center">
                    <span
                        className={row.statut === "wait" ? "badge badge-warning text-white p-1" : "badge badge-success text-white p-1"}>
                                            ...
                                            <TableRow>
                                                {
                                                    row.statut === "wait" &&
                                                    <TableCell align="center"
                                                               style={{fontWeight: "bold"}}>Actions</TableCell>
                                                }
                                                <TableCell align="center" style={{fontWeight: "bold"}}>
                                                    <div style={{display: "flex"}}>
                                                        ...
                                                        >
                                                            {
                                                                sort === "asc" ? <ArrowDropDownIcon fontSize="small"/> :
                                                ...
                                                <TableCell align="center" style={{fontWeight: "bold"}}>Utilisateur
                                                    OA</TableCell>
                                                <TableCell align="center" style={{fontWeight: "bold"}}>Taux
                                                    horaire</TableCell>
                                        ...
                                        <div>
                                                        ...
                                                        }}>
                                                        {
                                                            localStorage.getItem("odoo_id") === "9035ce2a-a7a2-11eb-bcbc-0242ac130002" ?
                                                                data.oa_comptes_bank_factures_david.map((item, key) =>
                                                                    <option key={key}
                                                                            value={item.odoo_id}>{item.label}</option>
                                                                ) :
                                            ...
                                            <div className="row mt-2">
                                                ...
                                                <div className="col-md-4">
                                                    ...
                                                    <Sinput
                                                        label={
                                                            <Dropdown defaultValue='%' options={[{
                                                                key: "0",
                                                                text: "%",
                                                                value: "%"
                                                            }, {key: "1", text: "CHF", value: "CHF"}]}
                                                                      value={reductionType}
                                                                      onChange={(e, {value}) => {
                                                                          console.log(value)
            ...
            >
                <DialogTitle disableTypography id="form-dialog-title">
                    <Typography
                        variant="h6">{addUpdateModalType === "add" ? "Ajouter un TimeSheet" : "Modifier"}</Typography>
