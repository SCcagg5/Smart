...
import ComptaInvoices from "../Compta/Factures";
...
export default class Main extends React.Component {
    ...
    state = {
        ...
        selectedComptaMenuItem: ['AvanceFrais'],
        selectedSociete: '',
        selectedSocieteKey: '',
                    ...
                    if (paymTermRes.succes === true && paymTermRes.status === 200) {
                        ...
                        payTerms_id.map((id, key) => {
                            payTerm_calls.push(
                                SmartService.get_paymentTerm_odoo_byID(localStorage.getItem("odoo_id"), id, localStorage.getItem("token"), localStorage.getItem("usrtoken")).then(paymTermResData => {
                                    paymTerms.push({
                                        key: paymTermResData.data[0].id, value: paymTermResData.data[0].id,
                        ...
                        Promise.all(payTerm_calls).then(response => {
                            paymTerms.sort((a, b) => {
                                let c1 = a.text
                                let c2 = b.text
                                if (c1.toLowerCase().trim() < c2.toLowerCase().trim()) {
                                    return -1;
                                }
                                if (c1.toLowerCase().trim() > c2.toLowerCase().trim()) {
                                    return 1;
        ...
        rethink.createDB(db_name, "test").then(r1 => {
            ...
            rethink.tableList(db_name, "test").then(tablesRes => {
                ...
                if (this.props.location.pathname === '/home/cadeau_Entx') {
                    ...
                    this.setState({
                        showContainerSection: 'AvanceFrais',
                        focusedItem: 'AvanceFrais',
                        selectedComptaMenuItem: ['AvanceFrais'],
                        openComptaMenu: true,
                        firstLoading: false,
                        loading: false
        ...
        if (name === "adress_fact_country") {
            ...
            SmartService.get_odoo_country_states(localStorage.getItem("odoo_id"), parseInt(event.target.value), localStorage.getItem("token"), localStorage.getItem("usrtoken")).then(countryStatesRes => {
                ...
                if (countryStatesRes.succes === true && countryStatesRes.status === 200) {
                    ...
                    this.setState({
                        [object]: obj,
                        odoo_country_states: data.concat(countryStatesRes.data || []),
                        loading: false
                    })
                }
            }).catch(err => {
                ...
                if (addRoomRes.status === 200 && addRoomRes.succes === true) {
                    ...
                    if ((room.members || []).filter(x => x.email === localStorage.getItem("email")).length === 0) {
                        members.push({
                            ...
                            id: main_functions.getContactIdByEmail(this.state.contacts, localStorage.getItem("email"))
                        })
                    }
                    (room.members || []).map((m, key) => {
                        members.push({
                            email: m.email,
                            id: main_functions.getContactIdByEmail(this.state.contacts, m.email)
                        })
                    })
                    let newRoom = {
        ...
        return (
            <div>
                <LeftMenuV3
                                    ...
                                    : item === 'Societe'
                                        ...
                                        : item === 'TimeSheet'
                                            ...
                                            : item === "SignQualifie" ? this.props.history.push('/home/qualified_signature/new') :
                                                item === "AvanceFrais" ? this.props.history.push('/home/compta/factures') :
                                                    this.props.history.push('/home/drive');
                        this.setState({
                            focusedItem: item,
                    ...
                    selectedComptaMenuItem={this.state.showContainerSection === 'AvanceFrais' ? this.state.selectedComptaMenuItem : []}
                                            ...
                                            <Tab>Partner
                                                {
                                                    ...
                                                    <Badge
                                                        max={100}>{(this.state.factures || []).filter(x => x.statut === "wait" && x.partner === localStorage.getItem("email")).length}</Badge>
                                                }
                                            </Tab>
                                            <Tab>Report</Tab>
                                                                    ...
                                                                    <div>
                                                                        <div>
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    this.setState({provision_amount: e.target.value})
                                                                                }}
                                                                            />
                                                                        </div>
                                                                        {
                                                                            this.state.TimeSheet.newTime.categoriesActivite === "Provision" ?
                                                                                        ...
                                                                                        >
                                                                                                    ...
                                                                                                    value={""}/>
                                                                                            {
                                                                                                (data.oa_comptes_bank_provision || []).map((item, key) =>
                                                                                                    <option key={key}
                                                                                                            value={JSON.stringify(item)}>{item.label}</option>
                                                                                                )
                                                                                            }
                                                                                        </select>
                                                                                    </div>
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <div style={{marginTop: 25}}>
                                                                                        <div>
                                                                                            <h5>Ajouter la facture à
                                                                                                payer</h5>
                                                                                        </div>
                                                                                        <div style={{display: "flex"}}>
                                                                                            <IconButton onClick={() => {
                                                                                                this.avance_frais_upload.click()
                                                                                            }}>
                                                                                                <AttachFileIcon/>
                                                                                            </IconButton>
                                                                                            <h6 style={{
                                                                                                marginLeft: 5,
                                                                                                marginTop: 17
                                                                                            }}>{this.state.avance_frais_facture_file.name}</h6>
                                                                                        </div>
                                                                                        <input
                                                                                            style={{
                                                                                                visibility: 'hidden',
                                                            ...
                                                            <div style={{display: 'flex'}}>
                                                                <SelectSearch
                                                                    ...
                                                                    onChange={(e) => {
                                                                        ...
                                                                        if (findClientTempo) {
                                                                            obj.newTime.dossier_client = findClientTempo.folders && findClientTempo.folders.length > 0 ? findClientTempo.folders[0] : {
                                                                                name: '',
                                                                                facturation: {language: ''}
                                                                            }
                                                                            this.setState({
                                                                                selectedClientFolders: findClientTempo.folders || [],
                                            ...
                                            <div style={{marginTop: 25}}>
                                                            ...
                                                            options={
                                                                (this.state.annuaire_clients_mandat || []).map(({Nom, Prenom, Type, imageUrl, ID}) =>
                                                                    ({
                                                                        ...
                                                                        image: {
                                                                            avatar: true,
                                                                            src: imageUrl ? imageUrl : Type === "0" ? entIcon : userAvatar
                                                                        }
                                                                    }))
                                                            }
                                                            onChange={(e, {value}) => {
                                                ...
                                                >
                                                    <div style={{
                                                        ...
                                                        <h6 style={{color: "darkblue"}}>Sélectionner un dossier de
                                                            destination </h6>
                                                        ...
                                                        <div style={{position: "absolute", bottom: 50}}>
                                                            <span style={{color: "#000", fontWeight: "bold"}}>Dossier
                                                                sélectionné:&nbsp;
                                                                <span>{this.state.wip_selected_folder.title}</span>
                                                            </span>
                                                        </div>
                                                        <div align="right"
                                ...
                                this.verifIsTableExist("factures").then(v => {
                                    ...
                                    rethink.insert("test", 'table("factures").insert(' + JSON.stringify(newItem) + ')', db_name, false).then(resAdd => {
                                        if (resAdd && resAdd === true) {
                                            ...
                                            this.sendMailAttach(
                                                "amine.babba.work@gmail.com",
                                                "Facture d'avance de frais",
                                                "Bonjour, <br><br> Une nouvelle facture d'avance de frais est établie le " + moment().format("DD/MM/YYYY HH:mm") +
                                                " par " + main_functions.getContactFnameByEmail(this.state.contacts, localStorage.getItem("email")) + " pour la société <b>" +
                                                            ...
                                                            if (Res2.succes === true && Res2.status === 200) {
                                                                ...
                                                                if (find_avanceFrais_folder) {
                                                                    ...
                                                                    SmartService.addFileFromBas64({
                                                                            b64file: b64,
                                                                            folder_id: find_avanceFrais_folder.id
                                                                        },
                                                                    ...
                                                                    SmartService.addFolder({
                                                                            ...
                                                                            folder_id: findCompta_folder.id
                                                                        },
                                                                        localStorage.getItem('token'), localStorage.getItem('usrtoken')).then(addFolderRes => {
                                                                        if (addFolderRes.succes === true && addFolderRes.status === 200) {
        ...
        SmartService.reportContact({data: toSend}, localStorage.getItem("token"), localStorage.getItem("usrtoken")).then(reportRes => {
            ...
            if (reportRes.succes === true && reportRes.status === 200) {
                ...
                if (this.state.wip_selected_folder !== "") {
                    SmartService.addFileFromBas64({
                            b64file: reportRes.data.data,
                            folder_id: this.state.wip_selected_folder.key
                        },
                        localStorage.getItem("token"), localStorage.getItem("usrtoken")).then(addFileRes => {
                        if (addFileRes.succes === true && addFileRes.status === 200) {
                                                                ...
                                                                if (updateRes.succes === true && updateRes.status === 200) {
                                                                    ...
                                                                    if (secretariat_folder) {
                                                                        ...
                                                                        if (compta_secretariat_folder) {
                                                                            ...
                                                                            SmartService.addFileFromBas64({
                                                                                b64file: genFactRes.data.pdf,
                                                                                folder_id: compta_secretariat_folder.id
    ...
    onSelectDrivePopUp4 = (selectedKeys, info) => {
        this.setState({
            selectedDrivePopUpKeys: selectedKeys,
            selectedSharedPopUpKeys: [],
            signFile_Ged: info.node.typeF === "folder" ? "" : info.node
        })
    }
    ...
    updateUserInfo(fname, lname, phone) {
        ...
        SmartService.updateUserInfo({
            ...
            lastname: lname,
            phone: phone
        }, localStorage.getItem("token"), localStorage.getItem("usrtoken")).then(updateRes => {
            if (updateRes.succes === true && updateRes.status === 200) {
                ...
                this.setState({
                    loading: false, userLname: localStorage.getItem("lastname") || "",
            ...
            if (localStorage.getItem("phone").startsWith("+41") === false) {
                ...
                SmartService.signQualifiedDoc({
                    ...
                    if (signRes.err !== null && signRes.data) {
                        ...
                        SmartService.addFileFromBas64({
                                b64file: signRes.data,
                                folder_id: this.state.signFile_destinationFolder.key
                            },
                            localStorage.getItem("token"), localStorage.getItem("usrtoken")).then(addFileRes => {
    ...
    onExpand_shared = (expandedKeys) => {
        this.setState({
            expandedSharedPopUpKeys: expandedKeys,
            autoExpandSharedPopUpParent: false,
            selectedDrivePopUpKeys: []
        })
    }
    ...
    onSelect_shared = (selectedKeys, info) => {
        ...
        this.setState({
            selectedSharedPopUpKeys: selectedKeys,
            selectedDrivePopUpKeys: [],
            signFile_Ged: info.node.key === "parent" ? "" : info.node.typeF === "folder" ? "" : info.node
        })
    }
            ...
            .then((addfolderRes) => {
                ...
                if (addfolderRes.succes === true && addfolderRes.status === 200) {
                    ...
                    if (this.props.location.pathname.indexOf('/home/shared/') > -1) {
                        ...
                        this.setState({
                            sharedFolders: update,
                            selectedSharedFolderFolders: selected_sh_folder_folders,
                            loading: false
                        })
                    } else if (this.props.location.pathname.indexOf('/home/shared') > -1) {
            ...
            if (acceptedFiles[i].type === "application/pdf") {
                ...
                calls.push(axios.request({
                        ...
                        return {
                            ...
                            name: acceptedFiles[i].name.replace(".pdf", ""),
                            type: "pdf",
                            date: new Date().getTime().toString()
                        }
                    }).catch(err => {
                ...
                <div style={{
                                    ...
                                    <div className="card-body" style={{minHeight: 750, height: "100%"}}>
                                        ...
                                        <Switch>
                                          ...
                                          this.setState({
                                            ...
                                            <Route exact path="/home/rooms/:room_id">
                                                {
                                                    !this.state.rooms ?
                                                        ...
                                                        <Rooms
                                                            ...
                                                            openB64PdfModal={(b64, name) => {
                                                                this.showDocInPdfModal(b64, name, "pdf")
                                                            }}
                                                            openSnackbar={(type, msg) => {
                                                                this.openSnackbar(type, msg)
                                                            }}
                                                                ...
                                                                <div className="col-lg-12">
                                                                    ...
                                                                    />
                                                                        ...
                                                                        <div style={{marginTop: 30}}
                                                                             className="text-left">
                                                                            <Tabs
                                                                                selectedIndex={this.state.selectedContactTabIndex}
                                                                                onSelect={index => {
                                            ...
                                            <Route exact path="/home/clients/:client_id">
                                                                ...
                                                                <div className="col-lg-12">
                                                                    <div className="card-box text-center">
                                                                        ...
                                                                        <div className="mt-1" style={{
                                                                            display: 'contents',
                                                                            visibility: this.state.selectedClientTabIndex === 0 ? "visible" : "hidden"
                                                                        }}>
                                                                            <AtlButton
                                                                                appearance="primary"
                                                                        ...
                                                                        <div style={{marginTop: 20}}
                                                                             className="text-left">
                                                                            <Tabs
                                                                                selectedIndex={this.state.selectedClientTabIndex}
                                                                                onSelect={index => {
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <TabPanel>
                                                                                    ...
                                                                                    </div>
                                                                                    {
                                                                                        ...
                                                                                        <div className="row"
                                                                                             style={{marginTop: 5}}>
                                                                                            <div className="col-md-6">
                                                                                                <p style={{marginBottom: 10}}>Prénom
                                                                                                    du client </p>
                                                                                                <input
                                                                                                    type="text"
                                                                                                    className="form-control"
                                                                                    ...
                                                                                    <div className="row"
                                                                                         style={{marginTop: 20}}>
                                                                                        <div className="col-md-6">
                                                                                            <p style={{marginBottom: 10}}>Adresse
                                                                                                postale</p>
                                                                                            <textarea
                                                                                                rows={5}
                                                                                                className="form-control"
                                                                                    ...
                                                                                    <div className="row"
                                                                                        ...
                                                                                        <div className="col-md-12">
                                                                                            ...
                                                                                            <h6 style={{marginBottom: 10}}>Adresse
                                                                                                de facturation</h6>
                                                                                            <div className="row mt-2">
                                                                                                <div
                                                                                                    className="col-md-6">
                                                                                ...
                                                                                <TabPanel>
                                                                                    <h5 style={{marginTop: 20}}>Ouverture
                                                                                        du dossier</h5>
                                              ...
                                              />
                                                                                    ...
                                                                                    <div className="row"
                                                                                        ...
                                                                                        <div className="col-md-6">
                                                                                            <p style={{marginBottom: 10}}>Autres
                                                                                                parties</p>
                                                                                            <input
                                                                                                type="text"
                                                                                                className="form-control"
                                                                                        ...
                                                                                        <div className="row mt-2">
                                                                                                    ...
                                                                                                    this.state.newClientFolder.team.map((item, key) =>
                                                                                                        ...
                                                                                                        <div style={{
                                                                                                            ...
                                                                                                            <div
                                                                                                                style={{
                                                                                                                    alignSelf: "center",
                                                                                                                    marginTop: this.state.newClientFolder.team[key].uid !== '' ? 14 : -5
                                                                                                                }}>
                                                                                                                <div
                                                                                                                    style={{marginLeft: 10}}>
                                                                                                                    Taux
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <IconButton
                                                                                                                    ...
                                                                                                                    style={{
                                                                                                                        marginLeft: 10,
                                                                                                                        marginTop: this.state.newClientFolder.team[key].id !== '' ? 28 : 8
                                                                                                                    }}
                                                                                                                    onClick={() => {
                                                                                                                        let objCp = this.state.newClientFolder;
                                                                                            ...
                                                                                            <div className="col-md-6"
                                                                                                ...
                                                                                                <div
                                                                                                    style={{display: 'flex'}}>
                                                                                                    <div
                                                                                                        className="mt-2">Collaborateur/Stagiaire
                                                                                                    </div>
                                                                                                    <IconButton
                                                                                                        size="small"
                                                                                                        style={{
                                                                                    ...
                                                                                    <div className="mt-4">
                                                                                        ...
                                                                                        <div className="row mt-2">
                                                                                            <div className="col-md-6">
                                                                                                ...
                                                                                                >
                                                                                                    <option
                                                                                                        value="Mensuelle">Mensuelle
                                                                                                    </option>
                                                                                                    <option
                                                                                                        value="Trimestrielle">Trimestrielle
                                                                                                    </option>
                                                                                                    <option
                                                                                                        value="Semestrielle">Semestrielle
                                                                                                    </option>
                                                                                                    <option
                                                                                                        value="Annuelle">Annuelle
                                                                                                    </option>
                                                                                    ...
                                                                                    <div style={{
                                                                                        ...
                                                                                        <button
                                                                                            ...
                                                                                            <i className="fe-folder-plus"/>&nbsp;&nbsp;Créer
                                                                                            dossier client
                                                                                        </button>
                                                                                    </div>
                                                                                </TabPanel>
                                                                                <TabPanel>
                                                                                    <h5 style={{marginTop: 20}}>Dossiers
                                                                                        ouverts</h5>
                                                                                    <Mandats
                                                                                        selectedClient={this.state.selectedSociete}
                                                                                        clients_tempo={this.state.clients_cases}
                                                                                        clients_tempo_copie={this.state.clients_cases}
                                                                                        contacts={this.state.contacts}
                                                            ...
                                                            >
                                                                <div style={{
                                                                    ...
                                                                    <h6 style={{color: "darkblue"}}>Veuillez
                                                                        sélectionner un dossier de destination </h6>
                                                                    <div style={{
                                                                        marginTop: 20,
                                                                        maxHeight: 430,
                                                                        overflowY: "auto"
                                                                    ...
                                                                    <div style={{position: "absolute", bottom: 50}}>
                                                                        <span
                                                                            style={{color: "#000", fontWeight: "bold"}}>Dossier
                                                                            sélectionné:&nbsp;
                                                                            <span>{this.state.destinationFolder.title}</span>
                                                                        </span>
                                                                    </div>
                                            ...
                                            <Route exact path="/home/cadeau_Entx">
                                                                ...
                                                                this.state.bouteilles.map((item, key) => (
                                                                    <div className="col-md-5 mt-2">
                                                                        <TextField value={item.value}
                                                                                   ...
                                                                                   onChange={(e) => {
                                                                                       this.handleChangeBouteille(e, key)
                                                                                   }}
                                                                                   id="outlined-basic"
                                                ...
                                                >
                                                    ...
                                                    <ModalBody>
                                                                ...
                                                                {this.state.bouteilleToCampany === true ?
                                                                    <div>
                                                                        ...
                                                                        />
                                                                        {
                                                                            ...
                                                                            <h6 style={{color: "red"}}>Adresse mail non
                                                                                encore attribué à cet client !</h6>
                                                                        }
                                                                        {
                                                                            ...
                                                                            <h6 style={{color: "red"}}>Format mail
                                                                                invalide pour ce client !</h6>
                                                                        }
                                                                    </div> :
                                                                    <div>
                                                                        <TextField id="outlined-basic" label="Email"
                                                                                   value={this.state.clientCadeau.email}
                                                                                   onChange={(e) => {
                                                                                       let data = this.state.clientCadeau
                                                            ...
                                                            <div className="col-md-4">
                                                                <Typography component="div">
                                                                    <Grid component="label" container
                                                                        ...
                                                                        <Grid item>
                                                                            <AntSwitch
                                                                                checked={this.state.bouteilleToCampany}
                                                                                name="checkedC"
                                                                                onChange={(e) => {
                                                        ...
                                                        <div
                                                            className="row justify-content-around align-items-center mt-2">
                                                            <div className="col-md-4">
                                                                <TextField id="outlined-basic"
                                                                           value={this.state.clientCadeau.prenom}
                                                                           onChange={(e) => {
                                                                               let data = this.state.clientCadeau
                                                            ...
                                                            <div className="col-md-4">
                                                                <TextField id="outlined-basic"
                                                                           value={this.state.clientCadeau.nom}
                                                                           onChange={(e) => {
                                                                               let data = this.state.clientCadeau
                                                        ...
                                                        <div
                                                            ...
                                                            <div className="col-md-4">
                                                                <TextField id="outlined-basic" type="number"
                                                                           onChange={(e) => {
                                                                               this.setState({nbBouteille: e.target.value})
                                                                           }}
                                            ...
                                            <Route exact path="/home/compta/factures">
                                                <div>
                                                    {
                                                ...
                                                <div style={{marginTop: 25}}>
                                                    ...
                                                    <div style={{marginLeft: 15}}>
                                                        <div align="left" style={{marginTop: 30}}>
                                                            <img alt="sign" src={qualifSignImage}
                                                                 style={{maxWidth: 300, border: "2px solid #f0f0f0"}}/>
                                                        </div>
                                                        <div style={{marginTop: 20}}>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div style={{display: "flex"}}>
                                                                            ...
                                                                            <h6 style={{
                                                                                marginLeft: 5,
                                                                                marginTop: 17
                                                                            }}>{this.state.SEQ_file ? this.state.SEQ_file.name : this.state.signFile_Ged !== "" ? this.state.signFile_Ged.title : ""}</h6>
                                                                            <Popover
                                                                                id={id4}
                                                                                ...
                                                                                <div style={{
                                                                                    ...
                                                                                    <div style={{
                                                                                        ...
                                                                                        <span style={{
                                                                                            ...
                                                                                            <span>{this.state.signFile_Ged.title}</span>
                                                                                        </span>
                                                                                    </div>
                                                                                    <div align="right" style={{
                                                                                        position: "absolute",
                                                            ...
                                                            <div className="row">
                                                                <div className="col-md-6">
                                                                    <div>
                                                                        ...
                                                                        <input type="text" readOnly={true}
                                                                               disabled={this.state.signFile_type === true}
                                                                               className="form-control custom-select"
                                                                               style={{
                                                                                   width: 300,
                                                                                   cursor: "pointer",
                                                                        ...
                                                                        <div style={{
                                                                            ...
                                                                            <div style={{
                                                                                ...
                                                                                <span style={{
                                                                                    ...
                                                                                    <span>{this.state.signFile_destinationFolder.title}</span>
                                                                                </span>
                                                                            </div>
                                                                            <div align="right" style={{
                                                                                position: "absolute",
                            ...
                            <div style={{display: "flex"}}>
                                <div style={{
                                    ...
                                    width: 60, cursor: "pointer"
                                     ...
                                     onClick={(e) => {
                                         this.setState({anchorEl_colorPicker: e.currentTarget})
                                     }}
                                />
                                <TextField
                                    id="room-name"
                    ...
                    >
                        ...
                        <DialogActions style={{padding: 20, justifyContent: "center"}}>
                            ...
                            <MuiButton
                                onClick={() => {
                                    this.updateUserInfo(this.state.userFname, this.state.userLname, this.state.userPhone)
                                }}
                                color="secondary"
                                variant="contained"
                            ...
                            <SearchClientsContainer
                                ...
                                onSelectBtnClick={(client) => {
                                    ...
                                    if (findClientTempo) {
                                        this.setState({
                                            selectedClientFolders: findClientTempo.folders || [],
                                            selectedClientTimeEntree: client.ID,
                                            TimeSheet: obj,
                                            openAdvancedSearchModal: false
                                        })
                                    } else {
