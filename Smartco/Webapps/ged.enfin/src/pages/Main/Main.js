...
export default class Main extends React.Component {
        ...
        SmartService.getGed(
          ...
          .then((gedRes) => {
            if (gedRes.succes === true && gedRes.status === 200) {
              ...
              let meeturl = 'https://meet.smartdom.ch/enfin_' + moment().format('DDMMYYYYHHmmss');

              firebase.database().ref('/').on('value', (snapshot) => {
                  const data = snapshot.val() || [];
                  let contacts = data.enfin_collab || [];
                  let rooms = (data.rooms || []).filter(x => x.ged_id === "896ca0ed-8b4a-41fd-aeff-8de26ee1bcf9");
                  let societes = data.societes || [];
                  let annuaire_clients_mondat = data.enfin_contacts || [];
  ...
  saveContactChanges = () => {
    ...
    firebase.database().ref('enfin_collab/' + key).set(
  ...
  saveSocietyChanges = () => {
    ...
    firebase.database().ref('enfin_contacts/' + key).set(
                                        ...
                                        <div className="row" style={{ marginTop: 30 }}>
                                          <div className="col-md-6">
                                            ...
                                            <input
                                                ...
                                                id="email"
                                                name="email"
                                                value={this.state.selectedSociete.name}
                                                onChange={this.handleChange('selectedSociete', 'name')} />
                                        ...
                                        <div className="row" style={{ marginTop: 20 }}>
                                          <div className="col-md-6">
                                            ...
                                            <textarea
                                              ...
                                              id="about"
                                              name="about"
                                              value={this.state.selectedSociete.street}
                                              onChange={this.handleChange('selectedSociete', 'street')} />
                                          </div>
                                          <div className="col-md-6">
              ...
              <div className="row mt-3">
                <div className="col-md-6">
                  ...
                  <input
                      ...
                      id="nome"
                      name="nome"
                      value={this.state.newClient.street}
                      onChange={this.handleChange('newClient', 'street')} />
                </div>
                <div className="col-md-6">
                  <p style={{ marginBottom: 10 }}>Téléphone</p>
                  <input
