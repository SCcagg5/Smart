            ...
            <div className="mt-2" style={{textAlign:"right"}}>
                <div className="text-sm-right">
                    ...
                    <button style={{marginLeft:10}}
                            onClick={() => {
                                const r = window.confirm('Toutes les données de cet emplacement vont être remplacées ! Voulez-vous vraiment continuer ?');
                                if (r === true) {
                                    fileUpload.click();
                                }
                            }}
                    ...
                    <button style={{marginLeft:10}}
                            onClick={() => {
                                main_functions.exportCSVFile(searchFilter,"clients.csv")
                            }}
                    ...
                    <input
                        ...
                        onChange={(event) => props.onImportClick(event)}
                        type="file"
                        multiple={false}
