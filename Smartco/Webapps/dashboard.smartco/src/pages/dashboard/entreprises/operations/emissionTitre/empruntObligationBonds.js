                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="form-group">
                                                            ...
                                                            <select className="form-control custom-select"
                                                                    ...
                                                                    style={{borderRadius: 0, height: 45}}>
                                                                <option value="UtilityToken">Jeton utilitaire</option>
                                                                <option value="PayementToken">Jeton de paiement</option>
                                                                <option value="SecurityToken">Jeton de sécurité</option>
                                                                <option value="EquityToken">Jeton d'équité</option>
                                                            </select>
                                                            <ul className="mt-1">
                                                                <li style={{
                                                                    fontSize: "small",
                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="form-group">
                                                            ...
                                                            <select className="form-control custom-select"
                                                                    ...
                                                                    style={{borderRadius: 0, height: 45}}>
                                                                <option value="Altcoinomy">Altcoinomy</option>
                                                    ...
                                                    <div className="card-body">
                                                                ...
                                                                <div className="form-group">
                                                                    ...
                                                                    <div className="input-group mb-1">
                                                                        ...
                                                                        <input className="form-control" type="text"
                                                                               ...
                                                                               value="17551c150c0a846c078bb617da4eaba051d33622"/>
                                                                    </div>
                                                                    <span style={{color: "red", fontWeight: 900}}
                                                                          className="mb-1">Important:&nbsp;
                                                                        <span style={{
                                                            ...
                                                            <div className="col-md-12">
                                                                <div className="form-group">
                                                                    ...
                                                                    <select className="form-control custom-select"
                                                                            style={{borderRadius: 0, height: 45}}>
                                                                        <option value="Altcoinomy">Altcoinomy</option>
                                                                        <option value="NewOracle">New oracle</option>
                                                                    </select>
                                                        ...
                                                        <div style={{border: "1px solid grey", padding: 20}}>
                                                                    ...
                                                                    <div className="input-group mb-2">
                                                                        <div className="input-group-prepend"
                                                                            ...
                                                                            <div className="input-group-text"
                                                                                 style={{width: 100}}>
                                                                                <input style={{height: 29}} type="radio"
                                                            ...
                                                            <div className="row mt-1">
                                                                <div className="col-md-4"/>
                                                                <div className="col-md-2">
                                                                    With +{this.state.privateSaleBonusPercent}% bonus
                                                                </div>
                                                                <div className="col-md-6">
                                                                    <InputRange
                                                                        formatLabel={value => ``}
