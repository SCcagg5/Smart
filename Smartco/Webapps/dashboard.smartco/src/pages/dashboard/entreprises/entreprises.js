...
class entreprises extends Component {
    ...
    render() {
        ...
        let investisors = this.state.investisors;
        let approuvedCount = 0;
        let pendingCount = 0;
        let declinedCount = 0;
        ...
        return (
            <div>
                <TopBar logo={logo} height={90} onClickMenuIcon={() => this.setState({openSideMenu:true})} windowWidth={this.props.windowWidth}
                ...
                }
                {
                    this.state.loading === true ?
                        ...
                        <div style={{paddingLeft:this.props.windowWidth >=900 ? "10%":20,marginRight:20,marginTop:50}}>
                                ...
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <h4 className="mb-3" style={{color:"#000"}}>KYC</h4>
                                                </div>
...
export default windowSize(entreprises);