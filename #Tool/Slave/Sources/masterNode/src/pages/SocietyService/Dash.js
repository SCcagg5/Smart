                                                            ...
                                                            <tr key={key}>
                                                                ...
                                                                <td>
                                                                    <span className="badge bg-soft-warning text-warning p-1">{
                                                                        (parseInt(item.capital.totalCapital) / parseFloat(item.capital.valeurAction) ) + " actions"}
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <span className="badge bg-soft-danger text-danger p-1">{item.capital.totalCapital + (item.pays === "France" ? " €" : item.pays === "Switzerland" ? " CHF" : " TND")}</span>
                                                                </td>
